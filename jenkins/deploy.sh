...
sudo docker run -v /tmp/la.json:/.config/logging.json -p 58484:8484 -e DOCKER_HOST_IP=$HOST_IP --restart unless-stopped -d --name vdc-logging-agent ditas/vdc-logging-agent:v02 --testing
ENDSSH
